    ...
    <div class="row content ">
        <div class="col-12 pl-0 pr-0">
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">change Home Page </h4>
                </div>
            </div>
            <form method="POST" action="{{route('manage-headerFooter')}}" enctype="multipart/form-data" autocomplete=" " class="form-inline">
            @csrf
                <div class="form-group col-12 mb-3">
                    <label for="name" class="col-sm-3 col-form-label text-right">Organization Name</label>
                    <input id="name" type="text" class="col-sm-9 form-control @error('name')
                     is-invalid @enderror" name="name" value="{{$headerfooter->name}}" placeholder="Organization Name"
                      required autofocus>
                ...
                is-invalid @enderror" name="wonername" value="{{$headerfooter->wonername}}" placeholder="woner name"required>
                ...
                is-invalid @enderror" name="address" value="{{$headerfooter->address}}" placeholder="address"required>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="mobile" type="text" class="col-sm-9 form-control @error('mobile') is-invalid @enderror"
                     name="mobile" value="{{$headerfooter->mobile}}" placeholder="mobile" required>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="copyright" type="text" class="col-sm-9 form-control @error('copyright') is-invalid @enderror"
                     name="copyright" value="{{$headerfooter->Copyright}}" placeholder="copyright" required>
