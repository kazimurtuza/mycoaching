...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/assets/plugins/owl-carosel/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/assets/plugins/owl-carosel/css/owl.theme.default.css')}}">
    <!--    Magnetic Popup-->
    ...
    <link rel="stylesheet" href="{{asset('public/assets/css/sub-dropdown.css')}}">
    <!--    Data Table CSS-->
    <link rel="stylesheet" href="{{asset('public/assets/plugins/data-table/css/dataTables.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/assets/plugins/data-table/css/fixedHeader.bootstrap4.min.css')}}">
    <!--    Theme Stylesheet-->
...
<section>
    ...
    <h2 class="font-weight-bold p-1 m-0">{{$header->name}}</h2>
        <h5 class="menu-bg p-2 pl-3 pr-3 mb-1">{{$header->wonername}}</h5>
        <p class="font-weight-bold mb-0">address : {{$header->address}}</p>
    <p class="font-weight-bold mb-0">phone : {{$header->mobile}}</p>
    </div>
...
<!--User Avatar Start-->
<img class="avatar" src="@if(Auth::user()->pic){{asset(Auth::user()->pic)}} @else {{asset('public/assets/images/avatar.png')}}@endif" alt="Avatar">
<!--User Avatar Start-->
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @endif
                            @if(isset($header))
                            <li><a href="{{route('change-headerFooter')}}" class="dropdown-item">Manage Header & Footer</a></li>
                            @endif
                        </ul>
                    </li>
